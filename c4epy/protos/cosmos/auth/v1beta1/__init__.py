...
class QueryAccountAddressByIdRequest(betterproto.Message):
    ...
    """
    id is the account number of the address to be queried. This field should
    have been an uint64 (like all account numbers), and will be updated to
    uint64 in a future version of the auth query.
    """
