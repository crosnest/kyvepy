...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('ZJgithub.com/cosmos/ibc-go/v6/modules/apps/27-interchain-accounts/host/types'))
