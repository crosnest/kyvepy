...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('Z8github.com/cosmos/ibc-go/v6/modules/core/02-client/types'))
...
_QUERY = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\034\022\032/ibc/core/client/v1/params')),
  ),
  _descriptor.MethodDescriptor(
