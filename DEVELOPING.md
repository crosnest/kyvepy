...
3. Define an `upstream` remote pointing back to the main CosmPy repository:
   ...
   ``` shell
   git remote add upstream https://github.com/crosnest/kyvepy.git
   ```
...
[contributing guide]: https://github.com/crosnest/kyvepy/blob/master/CONTRIBUTING.md
[release process]: https://github.com/crosnest/kyvepy/blob/master/scripts/RELEASE_PROCESS.md
[repo]: https://github.com/crosnest/kyvepy
